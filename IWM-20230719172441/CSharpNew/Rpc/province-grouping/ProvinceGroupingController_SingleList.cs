...
{
    public class ProvinceGroupingController_SingleList : RpcController
    {
        private readonly IStatusService StatusService;
        private readonly IProvinceGroupingService ProvinceGroupingService;
        private readonly ICurrentContext CurrentContext;
        public ProvinceGroupingController_SingleList(
        ...
        [Route(ProvinceGroupingRoute.SingleListProvinceGrouping), HttpPost]
        public async Task<List<ProvinceGrouping_ProvinceGroupingDTO>> SingleListProvinceGrouping([FromBody] ProvinceGrouping_ProvinceGroupingFilterDTO ProvinceGrouping_ProvinceGroupingFilterDTO)
        {
            ...
            ProvinceGroupingFilter.StatusId = new IdFilter { Equal = Status.ACTIVE.Id };
        ...
        [Route(ProvinceGroupingRoute.SingleListStatus), HttpPost]
        public async Task<List<ProvinceGrouping_StatusDTO>> SingleListStatus([FromBody] ProvinceGrouping_StatusFilterDTO ProvinceGrouping_StatusFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
