...
{
    public class WorkerController_FilterList : RpcController
    {
        ...
        public WorkerController_FilterList(
        ...
        [Route(WorkerRoute.FilterListDistrict), HttpPost]
        public async Task<List<Worker_DistrictDTO>> FilterListDistrict([FromBody] Worker_DistrictFilterDTO Worker_DistrictFilterDTO)
        {
        ...
        [Route(WorkerRoute.FilterListNation), HttpPost]
        public async Task<List<Worker_NationDTO>> FilterListNation([FromBody] Worker_NationFilterDTO Worker_NationFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(WorkerRoute.FilterListProvince), HttpPost]
        public async Task<List<Worker_ProvinceDTO>> FilterListProvince([FromBody] Worker_ProvinceFilterDTO Worker_ProvinceFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(WorkerRoute.FilterListSex), HttpPost]
        public async Task<List<Worker_SexDTO>> FilterListSex([FromBody] Worker_SexFilterDTO Worker_SexFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(WorkerRoute.FilterListStatus), HttpPost]
        public async Task<List<Worker_StatusDTO>> FilterListStatus([FromBody] Worker_StatusFilterDTO Worker_StatusFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(WorkerRoute.FilterListWard), HttpPost]
        public async Task<List<Worker_WardDTO>> FilterListWard([FromBody] Worker_WardFilterDTO Worker_WardFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(WorkerRoute.FilterListWorkerGroup), HttpPost]
        public async Task<List<Worker_WorkerGroupDTO>> FilterListWorkerGroup([FromBody] Worker_WorkerGroupFilterDTO Worker_WorkerGroupFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(WorkerRoute.FilterListSelectOption), HttpPost]
