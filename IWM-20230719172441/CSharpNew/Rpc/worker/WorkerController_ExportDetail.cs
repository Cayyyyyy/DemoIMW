...
{
    public class WorkerController_ExportDetail : RpcController
    {
        private const string TEMPLATE_CODE = "IWM_Worker_DETAIL";
        private readonly IWorkerService WorkerService;
        private readonly ICurrentContext CurrentContext;
        public WorkerController_ExportDetail(
        ...
        [Route(WorkerRoute.DynamicTemplateDetailList), HttpPost]
        ...
        [Route(WorkerRoute.DynamicTemplateDetailPreview), HttpPost]
        [Route(WorkerRoute.DynamicTemplateDetailPdfDownload), HttpPost]
        ...
        [Route(WorkerRoute.DynamicTemplateDetailOriginalDownload), HttpPost]
