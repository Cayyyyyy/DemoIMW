...
namespace IWM.Repositories
{
    ...
    public class UOW : IUOW
    {
        ...
        public UOW(ICurrentContext CurrentContext)
        {
            this.CurrentContext = CurrentContext;
        }
        public void LoadConfiguration()
        {
            this.DataContext = new DataContext(CurrentContext.GetDataContextOptions<DataContext>());
        ...
        {
            if(DataContext == null)
                DataContext = new DataContext(CurrentContext.GetDataContextOptions<DataContext>());
            return DataContext;
        }
