...
namespace IWM.Repositories
{
    ...
    public class WorkerRepository : IWorkerRepository
    {
        ...
        {
            Dictionary<WorkerOrder, LambdaExpression> CustomOrder = new Dictionary<WorkerOrder, LambdaExpression>()
            {
                { WorkerOrder.District, (WorkerDAO x) => x.District.Name  },
                { WorkerOrder.Nation, (WorkerDAO x) => x.Nation.Name  },
                { WorkerOrder.Province, (WorkerDAO x) => x.Province.Name  },
                { WorkerOrder.Sex, (WorkerDAO x) => x.Sex.Name  },
                { WorkerOrder.Status, (WorkerDAO x) => x.Status.Name  },
                { WorkerOrder.Ward, (WorkerDAO x) => x.Ward.Name  },
                { WorkerOrder.WorkerGroup, (WorkerDAO x) => x.WorkerGroup.Name  },
            };
