...
namespace IWM.Repositories
{
    ...
    public class WorkerGroupRepository : IWorkerGroupRepository
    {
        ...
        {
            Dictionary<WorkerGroupOrder, LambdaExpression> CustomOrder = new Dictionary<WorkerGroupOrder, LambdaExpression>()
            {
                { WorkerGroupOrder.Status, (WorkerGroupDAO x) => x.Status.Name  },
            };
