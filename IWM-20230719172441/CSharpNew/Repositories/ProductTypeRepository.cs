...
namespace IWM.Repositories
{
    ...
    public class ProductTypeRepository : IProductTypeRepository
    {
        ...
        {
            Dictionary<ProductTypeOrder, LambdaExpression> CustomOrder = new Dictionary<ProductTypeOrder, LambdaExpression>()
            {
                { ProductTypeOrder.Status, (ProductTypeDAO x) => x.Status.Name  },
            };
