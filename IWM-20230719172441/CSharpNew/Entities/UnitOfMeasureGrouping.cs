...
{
    public class UnitOfMeasureGrouping : DataEntity
    {
    ...
    public class UnitOfMeasureGroupingFilter : FilterEntity
    {
        ...
        public UnitOfMeasureGroupingSelect Selects { get; set; } = UnitOfMeasureGroupingSelect.ALL;
        public UnitOfMeasureGroupingSearch SearchBy { get; set; }
    }
    ...
    [Flags]
    public enum UnitOfMeasureGroupingSearch : long
    {
        ALL = E.ALL,
        Code = E._1,
        Name = E._2,
