...
namespace IWM.Services.MUnitOfMeasureGroupingContent
{
    ...
    public class UnitOfMeasureGroupingContentService : BaseService, IUnitOfMeasureGroupingContentService
    {
        ...
        {
            RabbitManager.PublishList(CurrentContext, UnitOfMeasureGroupingContents, MessageRoutingKey.UnitOfMeasureGroupingContentSync);
            ...
            RabbitManager.PublishList(CurrentContext, UnitOfMeasures, MessageRoutingKey.UnitOfMeasureUsed);
            RabbitManager.PublishList(CurrentContext, UnitOfMeasureGroupings, MessageRoutingKey.UnitOfMeasureGroupingUsed);
        }
    }
}
