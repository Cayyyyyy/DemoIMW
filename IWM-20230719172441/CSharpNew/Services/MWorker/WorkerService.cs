...
namespace IWM.Services.MWorker
{
    ...
    public class WorkerService : BaseService, IWorkerService
    {
        ...
        {
            RabbitManager.PublishList(CurrentContext, Workers, MessageRoutingKey.WorkerSync);
            ...
            RabbitManager.PublishList(CurrentContext, Districts, MessageRoutingKey.DistrictUsed);
            RabbitManager.PublishList(CurrentContext, Nations, MessageRoutingKey.NationUsed);
            RabbitManager.PublishList(CurrentContext, Provinces, MessageRoutingKey.ProvinceUsed);
            RabbitManager.PublishList(CurrentContext, Wards, MessageRoutingKey.WardUsed);
        }
    }
}
