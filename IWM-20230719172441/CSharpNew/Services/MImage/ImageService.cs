...
namespace IWM.Services.MImage
{
    ...
    public class ImageService : BaseService, IImageService
    {
        ...
        private const string LongTermRoute = "/rpc/utils-storage/file/long-term-upload";
        private const string ShortTermRoute = "/rpc/utils-storage/file/short-term-upload";
        private const string TemporaryRoute = "/rpc/utils-storage/file/temporary-upload";
        ...
        private async Task<string> CreateThumbnail(Image Image, string thumbnailPath, int width, int height, string route)
        {
            ...
            RestClient restClient = new RestClient(InternalServices.UTILS_STORAGE);
            ...
            try
            {
                ...
                {
                    return "/rpc/utils-storage/file/download" + response.Data.Path;
                }
                else
                {
        ...
        private async Task<Image> CallRequest(Image Image, string path, string url)
        {
            ...
            try
            {
                ...
                if (response.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    Image.Url = "/rpc/utils-storage/file/download" + response.Data.Path;
