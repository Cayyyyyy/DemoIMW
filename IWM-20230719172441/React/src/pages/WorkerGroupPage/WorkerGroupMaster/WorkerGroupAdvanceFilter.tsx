...
export interface  WorkerGroupFilterProps {
  filter?: any;
  setVisible?: any;
...
function WorkerGroupAdvanceFilter(props: WorkerGroupFilterProps) {
        ...
        <FilterPanel
            ...
            <FilterPanel.Left>
                        ...
                        <div className="m-t--2xl">
                          <CheckboxWrapper.Group
                            ...
                            getList={ workerGroupRepository.filterListStatus  }
                          />
                        </div>
            ...
            <FilterPanel.Right>
                <Row gutter={ { xs: 8, sm: 16, md: 24, lg: 32 } }>
                    ...
                    <AdvanceStringFilter label={ translate('workerGroups.code')}
                    ...
                    <Col lg={8} className="m-b--md">
                    <AdvanceStringFilter label={ translate('workerGroups.name')}
...
export default WorkerGroupAdvanceFilter;
