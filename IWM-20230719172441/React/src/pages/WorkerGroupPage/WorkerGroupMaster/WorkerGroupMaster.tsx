...
import WorkerGroupAdvanceFilter from "./WorkerGroupAdvanceFilter";
import { WorkerGroup, WorkerGroupFilter } from "models/WorkerGroup";
import "./WorkerGroupMaster.scss";
/* end general import */

/* begin individual import */
import { workerGroupRepository } from "../WorkerGroupRepository";
import WorkerGroupDetailDrawer from "../WorkerGroupDetail/WorkerGroupDetailDrawer";
import { useWorkerGroupMasterHook } from "./WorkerGroupMasterHook";
/* end individual import */

function WorkerGroupMaster() {
    ...
    const {
        ...
        } = useWorkerGroupMasterHook();
    
    
    return (
    <>
    <div className="page-content">
        <PageHeader title={translate("workerGroups.master.subHeader")}
                    breadcrumbItems={[ translate("workerGroups.master.header"), translate("workerGroups.master.subHeader") ]} />
        <LayoutMaster>
            <LayoutMaster.Title
                title={translate("workerGroups.master.title")}
                description={translate("workerGroups.master.subHeader")}
              />
    ...
    <input
        ...
        id="master-import"
        onClick={handleClick}
        onChange={handleImportList(workerGroupRepository.import)}
    />
    { visible &&
    <WorkerGroupAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
    <WorkerGroupDetailDrawer model={model}
 ...
 export default WorkerGroupMaster;
