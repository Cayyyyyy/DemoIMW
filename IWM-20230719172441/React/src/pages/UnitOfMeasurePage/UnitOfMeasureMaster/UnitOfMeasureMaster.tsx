...
import UnitOfMeasureAdvanceFilter from "./UnitOfMeasureAdvanceFilter";
...
import { useUnitOfMeasureMasterHook } from "./UnitOfMeasureMasterHook";
...
function UnitOfMeasureMaster() {
    ...
    const {
        ...
        handleGoCreate,
        handleGoDetail,
        } = useUnitOfMeasureMasterHook();
    
    
    return (
    <>
    <div className="page-content">
        <PageHeader title={translate("unitOfMeasures.master.subHeader")}
                    breadcrumbItems={[ translate("unitOfMeasures.master.header"), translate("unitOfMeasures.master.subHeader") ]} />
        <LayoutMaster>
            <LayoutMaster.Title
                title={translate("unitOfMeasures.master.title")}
                description={translate("unitOfMeasures.master.subHeader")}
              />
    ...
    <input
        ...
        id="master-import"
        onClick={handleClick}
        onChange={handleImportList(unitOfMeasureRepository.import)}
    />
    { visible &&
    <UnitOfMeasureAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
