...
import WorkerAdvanceFilter from "./WorkerAdvanceFilter";
import { Worker, WorkerFilter } from "models/Worker";
import "./WorkerMaster.scss";
/* end general import */

/* begin individual import */
import { workerRepository } from "../WorkerRepository";
import { useWorkerMasterHook } from "./WorkerMasterHook";
...
function WorkerMaster() {
    ...
    <div className="page-content">
        <PageHeader title={translate("workers.master.subHeader")}
                    breadcrumbItems={[ translate("workers.master.header"), translate("workers.master.subHeader") ]} />
        <LayoutMaster>
            <LayoutMaster.Title
                title={translate("workers.master.title")}
                description={translate("workers.master.subHeader")}
              />
    ...
    <input
        ...
        id="master-import"
        onClick={handleClick}
        onChange={handleImportList(workerRepository.import)}
    />
    { visible &&
    <WorkerAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
