...
import UnitOfMeasureGroupingContentAdvanceFilter from "./UnitOfMeasureGroupingContentAdvanceFilter";
...
import UnitOfMeasureGroupingContentDetailDrawer from "../UnitOfMeasureGroupingContentDetail/UnitOfMeasureGroupingContentDetailDrawer";
import { useUnitOfMeasureGroupingContentMasterHook } from "./UnitOfMeasureGroupingContentMasterHook";
...
function UnitOfMeasureGroupingContentMaster() {
    ...
    const {
        ...
        } = useUnitOfMeasureGroupingContentMasterHook();
    
    
    return (
    <>
    <div className="page-content">
        <PageHeader title={translate("unitOfMeasureGroupingContents.master.subHeader")}
                    breadcrumbItems={[ translate("unitOfMeasureGroupingContents.master.header"), translate("unitOfMeasureGroupingContents.master.subHeader") ]} />
        <LayoutMaster>
            <LayoutMaster.Title
                title={translate("unitOfMeasureGroupingContents.master.title")}
                description={translate("unitOfMeasureGroupingContents.master.subHeader")}
              />
            <LayoutMaster.Actions>
                ...
                <div className="page-master__filter-action-search d-flex align-items-center">
                  <InputSearch
                    value={filter?.search}
                    classFilter={ UnitOfMeasureGroupingContentFilter }
                ...
                <div className="page-master__actions  d-flex align-items-center">
                  ...
                  <Dropdown
                    dropdownRender={() => (
                      <UnitOfMeasureGroupingContentAdvanceFilter
                        filter={filter}
    ...
    <input
        ...
        id="master-import"
        onClick={handleClick}
        onChange={handleImportList(unitOfMeasureGroupingContentRepository.import)}
    />
    { visible &&
    <UnitOfMeasureGroupingContentAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
    <UnitOfMeasureGroupingContentDetailDrawer model={model}
