...
import { useAppUserMasterHook } from "./AppUserMasterHook";
...
function AppUserMaster() {
    ...
    <div className="page-content">
        <PageHeader title={translate("appUsers.master.subHeader")}
        ...
        <LayoutMaster>
            <LayoutMaster.Title
                ...
                description={translate("appUsers.master.subHeader")}
              />
    ...
    />
    { visible &&
    <AppUserAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
