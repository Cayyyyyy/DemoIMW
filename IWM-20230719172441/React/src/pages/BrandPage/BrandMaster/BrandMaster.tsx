...
import BrandDetailDrawer from "../BrandDetail/BrandDetailDrawer";
import { useBrandMasterHook } from "./BrandMasterHook";
...
function BrandMaster() {
    ...
    <div className="page-content">
        <PageHeader title={translate("brands.master.subHeader")}
                    breadcrumbItems={[ translate("brands.master.header"), translate("brands.master.subHeader") ]} />
        <LayoutMaster>
            <LayoutMaster.Title
                title={translate("brands.master.title")}
                description={translate("brands.master.subHeader")}
              />
    ...
    />
    { visible &&
    <BrandAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
    <BrandDetailDrawer model={model}
