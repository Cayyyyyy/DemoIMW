...
import ProductTypeAdvanceFilter from "./ProductTypeAdvanceFilter";
...
import ProductTypeDetailDrawer from "../ProductTypeDetail/ProductTypeDetailDrawer";
import { useProductTypeMasterHook } from "./ProductTypeMasterHook";
...
function ProductTypeMaster() {
    ...
    const {
        ...
        } = useProductTypeMasterHook();
    
    
    return (
    <>
    <div className="page-content">
        <PageHeader title={translate("productTypes.master.subHeader")}
                    breadcrumbItems={[ translate("productTypes.master.header"), translate("productTypes.master.subHeader") ]} />
        <LayoutMaster>
            <LayoutMaster.Title
                title={translate("productTypes.master.title")}
                description={translate("productTypes.master.subHeader")}
              />
    ...
    <input
        ...
        id="master-import"
        onClick={handleClick}
        onChange={handleImportList(productTypeRepository.import)}
    />
    { visible &&
    <ProductTypeAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
    <ProductTypeDetailDrawer model={model}
