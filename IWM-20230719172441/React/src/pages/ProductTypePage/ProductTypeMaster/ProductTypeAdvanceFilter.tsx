...
function ProductTypeAdvanceFilter(props: ProductTypeFilterProps) {
        ...
        <FilterPanel
            ...
            <FilterPanel.Right>
                <Row gutter={ { xs: 8, sm: 16, md: 24, lg: 32 } }>
                    ...
                    <AdvanceStringFilter label={ translate('productTypes.code')}
                    ...
                    <Col lg={8} className="m-b--md">
                    <AdvanceStringFilter label={ translate('productTypes.name')}
                    ...
                    <Col lg={8} className="m-b--md">
                    <AdvanceStringFilter label={ translate('productTypes.description')}
                    ...
                    <Col lg={8} className="m-b--md">
                    <AdvanceDateRangeFilter label={ translate('productTypes.createdAt')}
                    ...
                    <Col lg={8} className="m-b--md">
                    <AdvanceDateRangeFilter label={ translate('productTypes.updatedAt')}
                                                  onChange={handleChangeDateFilter({
                                                  fieldName: "updatedAt" ,
                                                  fieldType: ["greaterEqual", "lessEqual" ],
                                                  })}
...
export default ProductTypeAdvanceFilter;
