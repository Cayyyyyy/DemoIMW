...
import UnitOfMeasureGroupingAdvanceFilter from "./UnitOfMeasureGroupingAdvanceFilter";
...
import { useUnitOfMeasureGroupingMasterHook } from "./UnitOfMeasureGroupingMasterHook";
...
function UnitOfMeasureGroupingMaster() {
    ...
    const {
        ...
        handleGoCreate,
        handleGoDetail,
        } = useUnitOfMeasureGroupingMasterHook();
    
    
    return (
    <>
    <div className="page-content">
        <PageHeader title={translate("unitOfMeasureGroupings.master.subHeader")}
                    breadcrumbItems={[ translate("unitOfMeasureGroupings.master.header"), translate("unitOfMeasureGroupings.master.subHeader") ]} />
        <LayoutMaster>
            <LayoutMaster.Title
                title={translate("unitOfMeasureGroupings.master.title")}
                description={translate("unitOfMeasureGroupings.master.subHeader")}
              />
            <LayoutMaster.Actions>
                ...
                <div className="page-master__actions  d-flex align-items-center">
                  ...
                  <Dropdown
                    dropdownRender={() => (
                      <UnitOfMeasureGroupingAdvanceFilter
                        filter={filter}
    ...
    <input
        ...
        id="master-import"
        onClick={handleClick}
        onChange={handleImportList(unitOfMeasureGroupingRepository.import)}
    />
    { visible &&
    <UnitOfMeasureGroupingAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
