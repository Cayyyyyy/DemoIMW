...
import { useNationMasterHook } from "./NationMasterHook";
...
function NationMaster() {
    ...
    <div className="page-content">
        <PageHeader title={translate("nations.master.subHeader")}
                    breadcrumbItems={[ translate("nations.master.header"), translate("nations.master.subHeader") ]} />
        <LayoutMaster>
            <LayoutMaster.Title
                title={translate("nations.master.title")}
                description={translate("nations.master.subHeader")}
              />
    ...
    />
    { visible &&
    <NationAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
    <NationDetailDrawer model={model}
