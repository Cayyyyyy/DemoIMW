...
import { useDistrictMasterHook } from "./DistrictMasterHook";
...
function DistrictMaster() {
    ...
    const {
        ...
        handleGoCreate,
        handleGoDetail,
        } = useDistrictMasterHook();
    
    
    return (
    <>
    <div className="page-content">
        <PageHeader title={translate("districts.master.subHeader")}
                    breadcrumbItems={[ translate("districts.master.header"), translate("districts.master.subHeader") ]} />
        <LayoutMaster>
            <LayoutMaster.Title
                title={translate("districts.master.title")}
                description={translate("districts.master.subHeader")}
              />
    ...
    />
    { visible &&
    <DistrictAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
