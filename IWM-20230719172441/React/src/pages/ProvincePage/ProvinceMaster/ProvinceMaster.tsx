...
import { useProvinceMasterHook } from "./ProvinceMasterHook";
...
function ProvinceMaster() {
    ...
    const {
        ...
        handleGoCreate,
        handleGoDetail,
        } = useProvinceMasterHook();
    
    
    return (
    <>
    <div className="page-content">
        <PageHeader title={translate("provinces.master.subHeader")}
                    breadcrumbItems={[ translate("provinces.master.header"), translate("provinces.master.subHeader") ]} />
        <LayoutMaster>
            <LayoutMaster.Title
                title={translate("provinces.master.title")}
                description={translate("provinces.master.subHeader")}
              />
    ...
    />
    { visible &&
    <ProvinceAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
