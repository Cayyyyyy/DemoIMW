...
import { useWardMasterHook } from "./WardMasterHook";
...
function WardMaster() {
    ...
    <div className="page-content">
        <PageHeader title={translate("wards.master.subHeader")}
                    breadcrumbItems={[ translate("wards.master.header"), translate("wards.master.subHeader") ]} />
        <LayoutMaster>
            <LayoutMaster.Title
                title={translate("wards.master.title")}
                description={translate("wards.master.subHeader")}
              />
    ...
    />
    { visible &&
    <WardAdvanceFilter visible={visible}
                                   filter={filter}
                                   setVisible={setVisible}
                                   handleChangeAllFilter={handleChangeAllFilter} />
    }
    <WardDetailDrawer model={model}
