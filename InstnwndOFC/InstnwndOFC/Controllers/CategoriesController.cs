...
using InstnwndOFC.Models;

namespace InstnwndOFC.Controllers
{
    public class CategoriesController : Controller
    {
        private readonly instnwndContext _context;

        public CategoriesController(instnwndContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categories != null ? 
                          ...
                          Problem("Entity set 'instnwndContext.Categories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'instnwndContext.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
